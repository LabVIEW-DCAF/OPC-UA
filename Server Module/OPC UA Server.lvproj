...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="OPC UA Server configuration.lvclass" Type="LVClass" URL="../module/configuration/OPC UA Server configuration.lvclass"/>
		<Item Name="OPC UA Server editor node.lvclass" Type="LVClass" URL="../editor node/OPC UA Server editor node.lvclass"/>
		<Item Name="OPC UA Server runtime.lvclass" Type="LVClass" URL="../module/execution/OPC UA Server runtime.lvclass"/>
		<Item Name="OPC UA Server tests.lvlib" Type="Library" URL="../testing/OPC UA Server tests.lvlib"/>
